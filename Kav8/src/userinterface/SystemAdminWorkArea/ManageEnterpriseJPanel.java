...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (type == Enterprise.EnterpriseType.Supplier){
           SupplierEnterprise se = (SupplierEnterprise)enterprise;
           int quantity = 0;
           if(se.getOrganizationDirectory().getOrganizationList().size()==0){
        for(int i=0;i<5;i++){
            String s = "vaccine"+i;
            quantity = 10+i;
            Vaccine newVaccine = new Vaccine(s,quantity,i);
            
            se.getVaccineDirectory().getVaccineList().add(newVaccine);
        } 
